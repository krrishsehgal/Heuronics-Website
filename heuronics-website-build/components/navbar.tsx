        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Link href="/request-demo">
              <Button className="bg-primary text-primary-foreground hover:bg-primary/90">Request a Demo</Button>
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 space-y-4">
            ...
            <Link href="/request-demo" onClick={() => setMobileMenuOpen(false)}>
              <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90">Request a Demo</Button>
            </Link>
          </div>
        )}
      </div>
